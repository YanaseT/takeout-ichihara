...
//const tagTemplate = path.resolve(`./src/components/tags`)
...
exports.createPages = async ({ graphql, actions, reporter }, themeOptions) => {
  ...
  if (tagresult.errors) {
    reporter.panic(tagresult.errors)
  }*/
  ...
  /*const tags = tagresult.data.tags.group
    tags.forEach(tag => {
      console.log(JSON.stringify)(tags.fieldValue,null,4)
      createPage({
